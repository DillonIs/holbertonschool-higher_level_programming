#!/usr/bin/python3
"""Class defined as Rectangle based on 8-rectangle.py"""
...
class Rectangle:
    ...
    def square(cls, size=0):
        """Class method creates a Rectangle instance with equal size
        cls: Used to access class attributes
        size: Defines the size of instance, defaults at 0
